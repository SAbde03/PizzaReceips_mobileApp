...
import com.example.pizzaapp.Adapter.ProduitAdapter;
...
public class ListPizzaActivity  extends AppCompatActivity implements AdapterView.OnItemClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        liste.setAdapter(new ProduitAdapter(this, ps.findAll()));
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        TextView nom = view.findViewById(R.id.nompizza);
        ...
        alertDialogBuilder.setPositiveButton("Supprimer", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                liste.setAdapter(new ProduitAdapter(ListPizzaActivity.this, ps.findAll()));
            }
        });
        alertDialogBuilder.setNegativeButton("Détails", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(ListPizzaActivity.this, DetailProduit.class);
